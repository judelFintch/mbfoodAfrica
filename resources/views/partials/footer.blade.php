            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 md:gap-10 pb-10">
                <div class="col-span-2 space-y-7">
                    <div class="flex flex-col gap-5">
                        ...
                        Manger rapidement et facilement, c'est possible avec chez nous! Commandez en ligne et faites-vous livrer ou venez retirer votre commande en magasin
                        </p>
                    </div>
